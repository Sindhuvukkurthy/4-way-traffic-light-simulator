...
digitalWrite(Motor11, LOW);
digitalWrite(Motor12, LOW); // Set motor 1 to stop
digitalWrite(Motor21, LOW); // Set motor 2 to stop
digitalWrite(Motor22, LOW); // Set motor 2 to stop (redundant)

delay(10000); // Wait for 10 seconds

Serial.println("stop"); // Print message to serial monitor
}
}